...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Nouvelle réservation utilisateur
        ...
        $stmt = $pdo->prepare("INSERT INTO reservations (nom, prenom, date_demande, status) VALUES (:nom, :prenom, :date_demande, 'En attente')");
        $stmt->execute([
            ':nom' => $nom,
            ':prenom' => $prenom,
...
<?php if ($is_admin): ?>
    ...
    <?php else: ?>
        ...
        <table>
            <thead>
                <tr>
                    <th>ID</th><th>Nom</th><th>Prénom</th><th>Date demande</th><th>Status</th><th>Action</th>
                </tr>
            </thead>
            <tbody>
