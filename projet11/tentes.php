        ...
        <div class="header-container">
            ...
            <nav class="main-nav">
                <ul class="nav-list">
                    ...
                    <li><a href="#services.php" class="nav-link"><i class="fas fa-concierge-bell"></i> Services</a></li>
...
<section id="services" class="services-section" >
          ...
          <div class="section-header">
            ...
            <p class="section-subtitle">vos models de chaises</p>
         ...
         <section class="service-d" id="service-d">
            ...
            <div class="service-d-box">
                <img src="img/te4.jpeg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te5.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te6.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            <div class="service-d-box">
                <img src="img/te7.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

           
            <div class="service-d-box">
                <img src="img/te8.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te9.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te10.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te11.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te12.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te13.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te14.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            <div class="service-d-box">
                <img src="img/te15.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            <div class="service-d-box">
                <img src="img/te16.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            <div class="service-d-box">
                <img src="img/te17.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            <div class="service-d-box">
                <img src="img/te18.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            <div class="service-d-box">
                <img src="img/te19.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
            ...
            <div class="service-d-box">
                <img src="img/te20.jpeg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te22.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te23.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te24.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>

            <div class="service-d-box">
                <img src="img/te25.jpg" alt="">
                <div class="prix-a">5£ </div>
            </div>
        ...
        <div class="footer-container">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="propos.php"><i class="fas fa-chevron-right"></i> À Propos</a></li>
